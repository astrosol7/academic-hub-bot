...
from src.core.models import ScreenView, CourseManifest, CategoryDefinition
...
class TelegramRenderer:
    def __init__(self, bot: Bot, voyager_url: str | None = None) -> None:
        self.bot = bot
        self.voyager_url = voyager_url
