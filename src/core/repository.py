...
class PostgresContentRepository:
    ...
    def __init__(self, engine=None):
        from backend.api.database_postgresql import engine as default_engine, SessionLocal
        from backend.api.models import Institution, Course, Resource, ResourceCategory
    ...
    def get_course_resources(self, course_id: str) -> List[Any]:
        ...
        from backend.api.models import ResourceStatus
        with self.SessionLocal() as db:
