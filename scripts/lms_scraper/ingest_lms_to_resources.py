"""
Copy PDFs from lms/pdfs/ into resources/institutions/<slug>/Quarter_*/ΓÇª

Week folders in the LMS path (e.g. ΓÇª/Week 3/ΓÇª, Week_05, wk-2) are mirrored under:
  ΓÇª/<course>/weeks/Week_NN/[optional subfolders]/file.pdf
...
.env: LMS_IGNORE_SUBMISSION_NAMES=ΓÇª
...
INSTITUTION_SLUG = os.environ.get("HUB_INSTITUTION_SLUG", "sit")
def resources_root() -> Path:
    return ROOT_DIR / "resources" / "institutions" / INSTITUTION_SLUG
